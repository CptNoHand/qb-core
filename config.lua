...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 2500, bank = 7500, crypto = 2 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
